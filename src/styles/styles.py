...
from src.assets.custom_errors import WidgetError, InputValidationError
...
STYLES = {
    ...
    "chart": {
        ...
        "x_ticks": {
            "rotation": 30, # 30 degree angle
            "ha": "center", # Center-aligned rotation
            "fontsize": 12
        },
        "y_ticks": {
            "fontsize": 12
        ...
        "spines": {
            "linewidth": 1.5    # Thicker border lines
        },
        "palettes": {
            "general": "Blues_d",
            "gender": ["pink", "#1E90FF"],  # Pink for Female, Blue for Male
            "school": "Set2",
            "income": "Set1"
        }
    }
